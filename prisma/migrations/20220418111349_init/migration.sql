...
*/
-- AlterTable
ALTER TABLE `module` ADD COLUMN `enabled` BOOLEAN NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Module` ADD CONSTRAINT `Module_guildId_fkey` FOREIGN KEY (`guildId`) REFERENCES `Guild`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
