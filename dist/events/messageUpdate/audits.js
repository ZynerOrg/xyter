...
exports.default = {
  execute: (oldMessage, newMessage) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const { footerText, footerIcon, successColor } = yield (0,
      getEmbedData_1.default)(newMessage.guild);
      ...
      if (!channel) return;
      if (channel.type !== discord_js_1.ChannelType.GuildText) return;
      channel
        .send({
          embeds: [
        ...
        .then(() => {
          ...
          logger_1.default.info(
            `Audit log sent for event messageUpdate in guild ${
              (_a =
                newMessage === null || newMessage === void 0
                  ? void 0
                  : newMessage.guild) === null || _a === void 0
                ? void 0
                : _a.name
            } (${
              (_b =
                newMessage === null || newMessage === void 0
                  ? void 0
                  : newMessage.guild) === null || _b === void 0
                ? void 0
                : _b.id
            })`
          );
        ...
        .catch(() => {
          var _a, _b;
          throw new Error(
            `Audit log failed to send for event messageUpdate in guild ${
              (_a =
                newMessage === null || newMessage === void 0
                  ? void 0
                  : newMessage.guild) === null || _a === void 0
