...
exports.default = (message) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (content === channelCounter.triggerWord)
      return logger_1.default === null || logger_1.default === void 0
        ? void 0
        : logger_1.default.silly(
            `User: ${
              author === null || author === void 0 ? void 0 : author.tag
            } (${
              author === null || author === void 0 ? void 0 : author.id
            }) in guild: ${
              guild === null || guild === void 0 ? void 0 : guild.name
            } (${
              guild === null || guild === void 0 ? void 0 : guild.id
            }) said the counter word: ${channelCounter.triggerWord}`
          );
    yield message
      .delete()
      .then(() =>
