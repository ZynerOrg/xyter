...
exports.default = {
  execute: (message) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      getEmbedData_1.default)(message.guild);
      ...
      channel
        ...
        .then(() => {
          ...
          logger_1.default.info(
            `Audit log sent for event messageDelete in guild ${
              (_a =
                message === null || message === void 0
                  ? void 0
                  : message.guild) === null || _a === void 0
                ? void 0
                : _a.name
            } (${
              (_b =
        ...
        .catch(() => {
          var _a, _b;
          throw new Error(
            `Audit log failed to send for event messageDelete in guild ${
              (_a =
                message === null || message === void 0
                  ? void 0
                  : message.guild) === null || _a === void 0
