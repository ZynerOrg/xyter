      ...
      channel
        ...
        .then(() => {
          ...
          logger_1.default.debug(
            `Audit log sent for event interactionCreate in guild ${
              (_a =
                interaction === null || interaction === void 0
                  ? void 0
                  : interaction.guild) === null || _a === void 0
                ? void 0
                : _a.name
            } (${
              (_b =
                interaction === null || interaction === void 0
                  ? void 0
                  : interaction.guild) === null || _b === void 0
                ? void 0
                : _b.id
            })`
          );
        ...
        .catch(() => {
          logger_1.default.silly(
            "Failed to send audit log for event interactionCreate"
          );
        });
    }),
};
