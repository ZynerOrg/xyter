...
exports.default = {
  execute: (message) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      yield (0,
      cooldown_1.default)(guild, author, "event-messageCreate-credits", createGuildMember.guild.creditsTimeout, true);
      yield (0,
      give_1.default)(guild, author, createGuildMember.guild.creditsRate);
    }),
};
