...
const execute = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      for (
        var _d = true,
          cooldownsObj_1 = __asyncValues(cooldownsObj),
          cooldownsObj_1_1;
        (cooldownsObj_1_1 = yield cooldownsObj_1.next()),
          (_a = cooldownsObj_1_1.done),
          !_a;
        ...
        try {
          ...
          const { guildId, userId, timeoutId, cooldown, createdAt } =
            cooldownObj;
          const dueDate = (0, date_fns_1.add)(createdAt, { seconds: cooldown });
          if (!(0, date_fns_1.isPast)(dueDate)) return;
          const duration = (0, date_fns_1.formatDuration)(
      ...
      try {
        if (!_d && !_a && (_b = cooldownsObj_1.return))
          yield _b.call(cooldownsObj_1);
      } finally {
