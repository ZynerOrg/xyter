...
const pluralize_1 = __importDefault(
        ...
        : guild.roles
            ...
            .then((role) =>
              __awaiter(void 0, void 0, void 0, function* () {
                ...
                const createGuildMember =
                  yield database_1.default.guildMember.upsert({
                    where: {
                      userId_guildId: {
                        userId,
                        guildId,
                ...
                // Get guild object
                const pricePerHour =
                  createGuildMember.guild.shopRolesPricePerHour;
                const updateGuildMember =
                  yield database_1.default.guildMember.update({
                    where: {
                      userId_guildId: {
                        userId,
                        guildId,
                ...
                const createShopRole =
                  yield database_1.default.guildShopRoles.upsert({
                    where: {
                ...
                yield (_a =
                  member === null || member === void 0
                    ? void 0
                    : member.roles) === null || _a === void 0
                  ? void 0
                  : _a.add(role === null || role === void 0 ? void 0 : role.id);
                logger_1.default === null || logger_1.default === void 0
                  ...
                  : logger_1.default.silly(
                      `Role ${
                        ...
                        user === null || user === void 0 ? void 0 : user.tag
                      }`
                    );
                const interactionEmbed = new discord_js_1.EmbedBuilder()
                  .setTitle("[:shopping_cart:] Buy")
                  .setDescription(
                    `You bought **${optionName}** for **${(0,
                    pluralize_1.default)(pricePerHour, "credit")}**.`
                  )
                  .setTimestamp()
                  .setColor(successColor)
                  .setFooter({ text: footerText, iconURL: footerIcon });
                return interaction === null || interaction === void 0
                  ? void 0
