...
exports.default = {
  ...
  execute: (interaction) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const { errorColor, successColor, footerText, footerIcon } = yield (0,
      ...
      if (optionAmount === null) {
        logger_1.default === null || logger_1.default === void 0
          ? void 0
          : logger_1.default.silly(`Amount is null.`);
      ...
      const dmUser =
        (_b =
          (_a =
            client === null || client === void 0 ? void 0 : client.users) ===
            null || _a === void 0
            ? void 0
            : _a.cache) === null || _b === void 0
          ? void 0
          : _b.get(user === null || user === void 0 ? void 0 : user.id);
      ...
      const api =
        axios_1.default === null || axios_1.default === void 0
          ? void 0
      ...
      yield (_d =
        api === null || api === void 0
          ...
          : api.post("vouchers", {
              ...
              memo: `${
                interaction === null || interaction === void 0
                  ? void 0
                ...
                (_c =
                  interaction === null || interaction === void 0
                    ? void 0
                    : interaction.user) === null || _c === void 0
                  ? void 0
                  : _c.id
              }`,
            })) === null || _d === void 0
        ...
        : _d.then(() =>
            __awaiter(void 0, void 0, void 0, function* () {
              logger_1.default === null || logger_1.default === void 0
                ? void 0
                : logger_1.default.silly(`Successfully created voucher.`);
              ...
              const dmEmbed = new discord_js_1.EmbedBuilder()
                ...
                .setFooter({ text: footerText, iconURL: footerIcon });
              yield dmUser === null || dmUser === void 0
                ? void 0
                : dmUser
                    .send({
                      embeds: [dmEmbed],
