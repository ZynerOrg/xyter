...
const encryption_1 = __importDefault(
...
exports.default = {
  ...
  execute: (interaction) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      getEmbedData_1.default)(interaction.guild); // Destructure
      const { guild, user, options } = interaction;
      const uses =
        options === null || options === void 0
          ? void 0
          : options.getInteger("uses");
      const creditAmount =
        options === null || options === void 0
          ? void 0
          : options.getInteger("credit");
      const channel =
        options === null || options === void 0
          ? void 0
        ...
        .post("vouchers", {
          ...
          memo: `[GIVEAWAY] ${
            ...
            (_a =
              interaction === null || interaction === void 0
                ? void 0
                : interaction.user) === null || _a === void 0
              ? void 0
              : _a.id
          }`,
        })
