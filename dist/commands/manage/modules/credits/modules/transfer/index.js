...
const transfer_1 = __importDefault(
  require("../../../../../../helpers/credits/transfer")
);
// Configurations
...
exports.default = {
  ...
  execute: (interaction) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      getEmbedData_1.default)(interaction.guild); // Destructure member
      const { guild, options } = interaction;
      // Get options
      const optionFromUser =
        options === null || options === void 0
          ? void 0
          : options.getUser("from");
      const optionToUser =
        options === null || options === void 0 ? void 0 : options.getUser("to");
      const optionAmount =
        options === null || options === void 0
          ? void 0
      ...
      yield (0,
      transfer_1.default)(guild, optionFromUser, optionToUser, optionAmount);
