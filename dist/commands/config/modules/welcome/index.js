    ...
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const status =
        options === null || options === void 0
          ? void 0
          : options.getBoolean("status");
      const joinChannel =
        options === null || options === void 0
          ? void 0
          : options.getChannel("join-channel");
      const leaveChannel =
        options === null || options === void 0
          ? void 0
          : options.getChannel("leave-channel");
      const joinChannelMessage =
        options === null || options === void 0
          ? void 0
          : options.getString("join-message");
      const leaveChannelMessage =
        options === null || options === void 0
          ? void 0
          : options.getString("leave-message");
