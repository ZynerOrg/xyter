...
const noSelfReputation_1 = __importDefault(
  require("./components/noSelfReputation")
);
...
exports.default = {
  ...
  execute: (interaction) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      getEmbedData_1.default)(guild);
      const optionAccount =
        options === null || options === void 0
          ? void 0
          : options.getUser("account");
      const optionType =
        options === null || options === void 0
          ? void 0
      ...
      yield (0,
      cooldown_1.default)(guild, user, commandId, parseInt(process.env.REPUTATION_TIMEOUT));
      switch (optionType) {
        case "positive": {
