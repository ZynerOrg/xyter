...
exports.default = {
  ...
  execute: (interaction) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      (0,
      checkPermission_1.default)(interaction, discord_js_1.PermissionsBitField.Flags.ManageMessages);
      const { errorColor, footerText, footerIcon } = yield (0,
      ...
      if (
        ((_a =
          interaction === null || interaction === void 0
            ? void 0
            : interaction.channel) === null || _a === void 0
          ? void 0
          : _a.type) !== discord_js_1.ChannelType.GuildText
      )
        return;
      yield interaction.channel.messages.fetch().then((messages) =>
        __awaiter(void 0, void 0, void 0, function* () {
          var _b;
          const messagesToDelete = (
            bots
              ? messages.filter((m) => {
                  ...
                  return (
                    ((_a =
                      m === null || m === void 0 ? void 0 : m.interaction) ===
                      null || _a === void 0
                      ? void 0
                      : _a.id) !== interaction.id
                  );
                })
              : messages.filter((m) => {
                  var _a, _b;
                  return (
                    ((_a =
                      ...
                      ? void 0
                      : _a.id) !== interaction.id &&
                    ((_b = m === null || m === void 0 ? void 0 : m.author) ===
                      null || _b === void 0
                      ? void 0
                      : _b.bot) !== true
                  );
          ...
          if (
            ((_b =
              interaction === null || interaction === void 0
                ? void 0
                : interaction.channel) === null || _b === void 0
              ? void 0
