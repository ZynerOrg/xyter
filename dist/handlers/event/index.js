...
const checkDirectory_1 = __importDefault(
  require("../../helpers/checkDirectory")
);
...
const register = (client) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!eventNames) return logger_1.default.warn("No available events found");
    const totalEvents = eventNames.length;
    let loadedEvents = 0;
    logger_1.default.info(`📡 Loading ${totalEvents} events`);
    // Import an event.
    const importEvent = (name) =>
      __awaiter(void 0, void 0, void 0, function* () {
        var _e;
        const event = yield ((_e = `../../events/${name}`),
        Promise.resolve().then(() => __importStar(require(_e))));
    ...
    try {
      for (
        var _d = true, eventNames_1 = __asyncValues(eventNames), eventNames_1_1;
        (eventNames_1_1 = yield eventNames_1.next()),
          (_a = eventNames_1_1.done),
          !_a;
      ...
      try {
        if (!_d && !_a && (_b = eventNames_1.return))
          yield _b.call(eventNames_1);
      } finally {
