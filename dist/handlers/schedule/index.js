...
const start = (client) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!jobNames) return logger_1.default.warn("⏰ No available jobs found");
    return yield Promise.all(
      jobNames.map((jobName) =>
        __awaiter(void 0, void 0, void 0, function* () {
          var _a;
          const job = yield ((_a = `../../schedules/${jobName}`),
          Promise.resolve().then(() => __importStar(require(_a))));
          return node_schedule_1.default.scheduleJob(job.options.schedule, () =>
            __awaiter(void 0, void 0, void 0, function* () {
