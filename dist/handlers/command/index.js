...
const register = (client) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Import an command.
    const importCommand = (name) =>
      __awaiter(void 0, void 0, void 0, function* () {
        var _e;
        const command = yield ((_e = `../../commands/${name}`),
    ...
    try {
      for (
        var _d = true,
          commandNames_1 = __asyncValues(commandNames),
          commandNames_1_1;
        (commandNames_1_1 = yield commandNames_1.next()),
          (_a = commandNames_1_1.done),
          !_a;
        ...
        try {
          ...
          yield importCommand(commandName).then(() => {
            return logger_1.default.verbose(
      ...
      try {
        if (!_d && !_a && (_b = commandNames_1.return))
          yield _b.call(commandNames_1);
      } finally {
